...
public class ParkingSlot {
    ...
    public ParkingSlot(){
        ...
        for(int x : config.Configuration.PAKRING_SLOT_X){
            ...
            parkingSpots.add(new ParkingSpot(x, config.Configuration.PARKING_ROW_Y[2]));
            parkingSpots.add(new ParkingSpot(x, config.Configuration.PARKING_ROW_Y[3]));
            parkingSpots.add(new ParkingSpot(x, config.Configuration.PARKING_ROW_Y[4]));
            parkingSpots.add(new ParkingSpot(x, config.Configuration.PARKING_ROW_Y[5]));
        }
    }
